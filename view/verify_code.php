...
<div class="container">
    ...
    <?php endif; ?>
    <form method="POST" action="../public/index.php?action=verify_code">
        <input type="text" name="code" placeholder="Código" required autofocus>
        <button type="submit">Verificar</button>
    </form>
    <a class="link" href="forgot_password.php">Voltar</a>
</div>
</body>
</html>
